...
RequiredModules = @(@{ModuleName = 'GenXdev.Windows'; ModuleVersion = '1.304.2025'; })
...
FileList = '.gitignore', 'GenXdev.Webbrowser.csproj', 
               'GenXdev.Webbrowser.Playwright.psm1', 'GenXdev.Webbrowser.psd1', 
