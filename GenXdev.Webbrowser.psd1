...
@{
    ...
    RequiredModules        = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion  = '1.28.2021'}, @{ModuleName = 'GenXdev.Windows'; ModuleVersion  = '1.28.2021'}, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion  = '1.28.2021'});
