...
RequiredModules = @(@{ModuleName = 'GenXdev.Windows'; ModuleVersion = '3.23.2026'; })
...
FunctionsToExport = 'Close-Webbrowser', 'Connect-PlaywrightViaDebuggingPort', 
               'Get-BrowserBookmark', 'Import-BrowserBookmarks', 
...
CmdletsToExport = 'Approve-FirefoxDebugging', 
               'Clear-WebbrowserTabSiteApplicationData', 'Close-WebbrowserTab', 
