...
@{
    ...
    RequiredModules = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.11.0'}, @{ModuleName = 'GenXdev.Windows'; ModuleVersion = '1.11.0'}, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.11.0'});
