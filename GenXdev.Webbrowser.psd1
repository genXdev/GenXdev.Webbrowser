...
@{
    ...
    Description       = 'Provides a collection of cmdlets that can run scripts in your chromium webbrowser tab'
    ...
    RequiredModules = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.0.0'});
    ...
    FileList          = @("GenXdev.Webbrowser.psd1", "GenXdev.Webbrowser.psm1", "LICENSE", "license.txt", "README.md", "Newtonsoft.Json.dll", "WebSocket4Net.dll", "SuperSocket.ClientEngine.dll", "GenXdev.Webbrowser.dll")
    ...
    HelpInfoURI       = 'https://github.com/renevaessen/GenXdev.Webbrowser/blob/main/README.md#syntax'
