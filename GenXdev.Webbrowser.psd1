...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.60.2024' }, @{ModuleName = 'GenXdev.Windows'; ModuleVersion = '1.60.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.60.2024' });

  # Assemblies that must be loaded prior to importing this module
  RequiredAssemblies   = @(

  ".\\dependencies\\System.Management.Automation.dll",
  ".\\dependencies\\GenXdev.Webbrowser.dll"
  )
  ...
  ".\\dependencies\\GenXdev.Webbrowser.deps.json",
  ".\\dependencies\\GenXdev.Webbrowser.dll",
  ".\\dependencies\\GenXdev.Webbrowser.pdb",
